...
public abstract class Speedometer extends Device {
    ...
    private float speedometerWidth = dpTOpx(20f);

    private int markColor = 0xAAA, lowSpeedColor = 0xFF00FF00, mediumSpeedColor = 0xFFFFFF00, highSpeedColor = 0xFFFF0000, backgroundCircleColor = 0x00FFFFFF;
    ...
    private int tickPadding = (int) dpTOpx(20f);
     ...
     */
    public void setRingWidth(float speedometerWidth) {
