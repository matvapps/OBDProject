...
public class DashboardSpeedometer extends Speedometer {
    ...
    public DashboardSpeedometer(Context context) {
        this(context, null);
    }

    public DashboardSpeedometer(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DashboardSpeedometer(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void defaultGaugeValues() {
        ...
        super.setValueTextSize(dpTOpx(16f));
    ...
    protected void defaultSpeedometerValues() {
        ...
        super.setTextSize(dpTOpx(11f));
        super.setBackgroundCircleColor(0x00FFFFFF);
        super.setRingWidth(dpTOpx(20f));
        super.setMaxValue(240);
    }
...
//        speedometerPaint.setStrokeCap(Paint.Cap.ROUND);
    ...
    protected void onSizeChanged(int w, int h, int oldW, int oldH) {
        ...
        float risk = getRingWidth() * 3.25f + getPadding();
        speedometerRect.set(risk, risk, getSize() - risk, getSize() - risk);

        float risk2 = getRingWidth() * 1.38f;
