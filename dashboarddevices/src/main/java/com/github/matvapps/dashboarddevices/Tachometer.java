...
import com.github.matvapps.dashboarddevices.components.Indicators.Indicator;
import com.github.matvapps.dashboarddevices.components.Indicators.NoIndicator;
import com.github.matvapps.dashboarddevices.components.note.Note;
import com.github.matvapps.dashboarddevices.util.OnPrintTickLabel;
...
public abstract class Tachometer extends Device {

    /**
     * needle point to {@link #currentSpeed}, cannot be null
     */
    private Indicator indicator;
    private boolean withIndicatorLight = true;
    private int indicatorLightColor = 0xBBFFFFFF;
    ...
    private int markColor = 0xAAA, lowSpeedColor = 0xFF00FF00, mediumSpeedColor = 0xFFFFFF00, highSpeedColor = 0xFFFF0000, backgroundCircleColor = 0xFFFFFFFF;

    private int startDegree = 150, endDegree = 390;
    /**
     * to rotate indicator
     */
     ...
     */
    private boolean tickRotation = false;
    private float initTickPadding = 0;
    private int tickPadding = (int) dpTOpx(15f);
    ...
    protected void drawIndicatorLight(Canvas canvas) {
        final float MAX_LIGHT_SWEEP = 40f;
        ...
        int startColor = Color.argb(35, Color.red(Color.WHITE), Color.green(Color.WHITE), Color.blue(Color.WHITE));
        int startColor1 = Color.argb(0, Color.red(Color.TRANSPARENT), Color.green(Color.TRANSPARENT), Color.blue(Color.TRANSPARENT));
        int startColor2 = Color.argb(0, Color.red(Color.WHITE), Color.green(Color.WHITE), Color.blue(Color.WHITE));


        int[] colors = new int[]{startColor, startColor1, startColor2};
    ...
    protected void drawTicks(Canvas c) {
        ...
        for (int i = 0; i < ticks.size(); i++) {
            ...
            if (tick == null)
                tick = getTickTextFormat() == FLOAT_FORMAT ? String.format(getLocale(), "%.1f", ticks.get(i) / 1000)
                        : String.format(getLocale(), "%d", ticks.get(i).intValue() / 1000);
