...
import com.github.matvapps.dashboarddevices.util.OnSectionChangeListener;
import com.github.matvapps.dashboarddevices.util.OnSpeedChangeListener;
...
public abstract class Gauge extends View {
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        maxSpeed = a.getFloat(R.styleable.Gauge_dd_maxSpeed, maxSpeed);
        minSpeed = a.getFloat(R.styleable.Gauge_dd_minSpeed, minSpeed);
        speed = minSpeed;
...
//        textPaint.setTextSize(a.getDimension(R.styleable.Gauge_dd_textSize, textPaint.getTextSize()));
        ...
        unitTextPaint.setTextSize(a.getDimension(R.styleable.Gauge_dd_unitTextSize, unitTextPaint.getTextSize()));
        useUnit = a.getBoolean(R.styleable.Gauge_dd_use_unit, true);
        String unit = a.getString(R.styleable.Gauge_dd_unit);
        this.unit = (unit != null) ? unit : this.unit;
        trembleDegree = a.getFloat(R.styleable.Gauge_dd_trembleDegree, trembleDegree);
        trembleDuration = a.getInt(R.styleable.Gauge_dd_trembleDuration, trembleDuration);
        lowSpeedPercent = a.getInt(R.styleable.Gauge_dd_lowSpeedPercent, lowSpeedPercent);
        mediumSpeedPercent = a.getInt(R.styleable.Gauge_dd_mediumSpeedPercent, mediumSpeedPercent);
        speedometerTextRightToLeft = a.getBoolean(R.styleable.Gauge_dd_textRightToLeft, speedometerTextRightToLeft);
        accelerate = a.getFloat(R.styleable.Gauge_dd_accelerate, accelerate);
        decelerate = a.getFloat(R.styleable.Gauge_dd_decelerate, decelerate);
        unitUnderSpeedText = a.getBoolean(R.styleable.Gauge_dd_unitUnderSpeedText, unitUnderSpeedText);
        unitSpeedInterval = a.getDimension(R.styleable.Gauge_dd_unitSpeedInterval, unitSpeedInterval);
        speedTextPadding = a.getDimension(R.styleable.Gauge_dd_speedTextPadding, speedTextPadding);
        String speedTypefacePath = a.getString(R.styleable.Gauge_dd_speedTextTypeface);
        if (speedTypefacePath != null)
            setSpeedTextTypeface(Typeface.createFromAsset(getContext().getAssets(), speedTypefacePath));
        String typefacePath = a.getString(R.styleable.Gauge_dd_textTypeface);
