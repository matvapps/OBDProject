...
public class WifiService {
    ...
    private class SocketTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                Message msg = mWIFIHandler.obtainMessage(OBDReader.MESSAGE_DEVICE_NAME);
                ...
                mConnectedThread = new WifiService.ConnectedThread(mSocket);
    ...
    private synchronized void setState(int state) {
        ...
        mWIFIHandler.obtainMessage(OBDReader.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
        ...
        public void writeDataToOBD(byte[] buffer) {
            try {
                if(mSocket != null)
                {
                    ...
                    outStream.flush();
                    mWIFIHandler.obtainMessage(OBDReader.MESSAGE_WRITE, -1, -1, buffer).sendToTarget();
                }
            ...
            while (true) {
                try {
                    if(mSocket != null)
                    {
                        ...
                        mWIFIHandler.obtainMessage(OBDReader.MESSAGE_READ, rawData.length(), -1, rawData).sendToTarget();
                    }
